...
void main(List<String> arguments) {
  var pagesWithContent = cut_vri_html_into_myanmar_edition_pages(
      readFile('../../anudipanipatha/e0401n.nrf.html'));
  var paragraphsByPage = extract_paragraphs_by_page(
  ...
  var paragraphsTableImport =
      create_sql_statements_from_paragraphs_by_page(paragraphsByPage)
          .join('\n');
