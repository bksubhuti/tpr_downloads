    ...
    for pid in sorted(paragraphs.keys()):
        ...
        for pali_line, trans_line in lines:
            ...
            if trans_line:
                ...
                # Uses both translation_text and dynamic lang classes
        ...
        for page_num_str, page_rows in pages_in_book:
            ...
            if assigned_bookid not in seen_books:
                disclaimer = (
                    ...
                    f'<i>Bản dịch AI của Epitaka.org (2026)---vui lòng sử dụng cẩn trọng.<br/>'
                    f'Bản dịch được tạo bằng dữ liệu myanmar nissaya do wikipali.org cung cấp.</i>'
                    f'</p>'
                )
                content = disclaimer + "\n\n" + content
